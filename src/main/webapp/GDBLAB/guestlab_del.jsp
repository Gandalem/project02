...
<SCRIPT language = "javascript"> 
	function check () {
		with(document.guestdel){
			if ( phone.value.length==0){
				alert ("전화번호를 입력해 주세요!!"); 
				phone.focus();
				return false; 
			}
			document.guestdel.submit(); 	
		}	
	}
</SCRIPT>
...
<body>
   ...
   <center>
   	<form name ="guestdel" method = "post" action = "guestlab_deldb.jsp">
   		...
   		<table width = "70%" cellspacing = "0" cellpadding="2"> 
   			...
   			<tr>
   				<td width ="124" height= "30" bgcolor= "#f4f4f4" align ="center" class= "input_style1">
   					전화번호 </td>
   				<td width = "494"> <input type="text" name = "phone" class = "input_style1">
